...
import Polimorfisme.Polimorfismo.Entrenador;
import Polimorfisme.Polimorfismo.Futbolista;
import Polimorfisme.Polimorfismo.Masajista;
import Polimorfisme.Polimorfismo.SeleccionFutbol;
	...
	public static void main(String[] args) {
		...
		for (SeleccionFutbol integrante : integrantes) {
			...
			integrante.jugarPartido();
                ...
                //SELECION
                System.out.println("Imprimir atri seleccion");
		for (SeleccionFutbol integrante : integrantes) {
			                 System.out.println( integrante.getNombre());
                                         System.out.println(SeleccionFutbol.seleccio);
		}
