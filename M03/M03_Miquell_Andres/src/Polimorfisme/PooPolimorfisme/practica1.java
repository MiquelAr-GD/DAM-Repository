...
public class practica1 {
        ...
        while (opcio != 0) {
            switch (opcio) {
                ...
                case 9:
                    ...
                    break;
                case 10:
                    imprimirTotDades(llibresArr);
                    break;
                case 11:
                    imprimirTotesEdiforials(llibresArr);
                    break;
            }
            opcio = menu(in);
        }
    ...
    public static void imprimirTotDades(llibres[] llibresArr){
        for (llibres llibre : llibresArr) {
            if(llibre != null){
            llibre.imprimeixTotesDades();
            }
        }
    }
     public static void imprimirTotesEdiforials(llibres[] llibresArr){
        for (llibres llibre : llibresArr) {
            if(llibre != null){
            llibre.mostraEditorial();
            }
        }
        /*Creo aquest metode com estatic per aixi poder recorrer l'array de llibres i aplicar el metode NO static de les classes a cada objecte*/
    }
    public static int menu(Scanner in) {
        ...
        System.out.println("10.Mostrar totes les dades");
        System.out.println("11.Mostrar totes les editorials");
    ...
    public static void emplenaDades(llibres[] llibresArr) {
        ...
        String ruta_fitxer = "C:\\Users\\MiquelA\\Documents\\NetBeansProjects\\M03_Miquell_Andres\\src\\Polimorfisme\\PooPolimorfisme\\llibres.csv";
        String linia;
        int i = 0, error = 0;
